...
public:
	...
	NETVAR(int, GetBurstShotsRemaining, "DT_WeaponCSBaseGun", "m_iBurstShotsRemaining");
	NETVAR(bool, IsBurstMode, "DT_WeaponCSBase", "m_bBurstMode");
...
public:
	...
	Vector        GetBtBonePos(int bone);
	bool IsVisible(C_BasePlayer* player, Vector start, Vector end);
	...
	bool CanSee(C_BasePlayer* ent, const Vector& pos);
	bool VisibleTo(C_BasePlayer* ent);
};
