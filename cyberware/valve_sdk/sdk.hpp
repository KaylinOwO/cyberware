...
inline GlowObjectManager*   g_GlowObjManager = nullptr;
...
inline int g_ScreenSizeW, g_ScreenSizeH;
...
inline int g_AimbotTargetIndex = 0;
inline C_LocalPlayer g_LocalPlayer;
inline CUserCmd* g_pCmd;
inline int g_TicksAllowed = 0;
inline int g_TicksChoke = 0;
inline int g_NextTickbaseShift = 0;
inline int g_TickbaseShift = 0;
inline int g_FixedTickbase = 0;
inline int g_BackupTickbase = 0;
inline bool g_DoubletapFire = false;
inline bool g_DoubletapAim = false;
inline bool g_DoubletapAimCheck = false;
inline const char* g_CurrentMap = "";
inline bool g_DiscordShutdown;
inline void(__thiscall* g_SetAbsOrigin)(C_BasePlayer*, const Vector&);
