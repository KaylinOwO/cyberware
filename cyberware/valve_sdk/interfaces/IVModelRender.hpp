...
public:
    ...
    virtual c_material_var*           FindVar(const char *varName, bool *found, bool complain = true) = 0;
    ...
    virtual c_material_var**          GetShaderParams(void) = 0;
    virtual bool                    IsErrorMaterial() const = 0;
    virtual void                    Unused() = 0;
    virtual float                   GetAlphaModulation() = 0;
    virtual void                    GetColorModulation(float *r, float *g, float *b) = 0;
    virtual bool                    IsTranslucentUnderModulation(float fAlphaModulation = 1.0f) const = 0;
    virtual c_material_var*           FindVarFast(char const *pVarName, unsigned int *pToken) = 0;
